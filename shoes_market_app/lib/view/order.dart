                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text('수량 : ${snapshot.data![0].quantity.toString()}'),
                          ],
                        ),
                        Row(
                          children: [
                            Text('Size : ${snapshot.data![0].size.toString()}'),
                            Text('가격 : ${snapshot.data![0].price.toString()}')
                          ],
                        ),
                        Row(
                          children: [
                            Text('색상 : ${snapshot.data![0].color}'),
                            Text('구매일자 : ${snapshot.data![0].date}')
                          ],
                        )
                      ],
                    ),
